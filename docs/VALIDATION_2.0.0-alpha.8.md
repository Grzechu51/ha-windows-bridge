# Walidacja 2.0.0-alpha.8

- Pełny zestaw: 274 testy pytest zaliczone. Instalator i oba ZIP-y zbudowane; smoke-test gotowego EXE zakończony powodzeniem. Wersja EXE i manifestu integracji zgodna: alpha.8.
...
- Nowe regresje alpha.8: natywny region HWND ma właściwy rozmiar i promień; karta zachowuje 520 × 214 px dla kwadratowej, poziomej i pionowej okładki oraz długiego tytułu.
